...
VALUES ('$name','$email','$message')";
  ...
  if ($this->con->query($sql) == TRUE) {
    ...
    echo "Oops something wwnt wrong" . $this->con->error;
  }
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $addingMessage = new MessageUs($con);
  $addingMessage->addMessage($name, $email, $message);
  $addingMessage->closeConnection();
...
<body>
  <header>
    <div class="headeri">
      ...
      <div class="aromé">
        <p>
          <a href="home.php" style="text-decoration: none; color: #363a4f">aromé</a>
        </p>
      </div>
    </div>
    <ul>
  ...
  <footer>
    <div class="f">
      ...
      <div class="ff">
        ...
        <a href="https://www.pinterest.com/"><img src="icons/pinterest.svg" alt="" /></a>
        <a href="https://twitter.com/"><img src="icons/twitter.svg" alt="" /></a>
